  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-50 to-pink-50 flex flex-col">
      ...
      <div className="flex flex-1 pt-16">
        <div className="fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 bg-white shadow-xl border-r border-gray-200">
          <div className="p-4">
    ...
    <>
      ...
      <div className="mb-8">
        <div className="mb-6 flex items-center">
          <span className="mr-4">Source of skills:</span>
          <div className="inline-flex rounded-md shadow-sm">
            <button
              onClick={() => setUseResume(true)}
              className={`px-4 py-2 text-sm font-medium rounded-l-lg cursor-pointer transition-all duration-300 ${
                useResume
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-r-lg cursor-pointer transition-all duration-300 ${
                !useResume
                  ? "bg-purple-600 text-white"
                  : "bg-white text-purple-600 hover:bg-gray-50"
              }`}
      ...
      <div className="mb-8 bg-white p-6 rounded-lg shadow-lg">
        <div className="flex justify-between items-center mb-4">
          ...
          {useResume && skills.length > 0 && (
            <button
              ...
              className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all duration-300 cursor-pointer"
            >
              Select All Skills
            </button>
          )}
        ...
        {useResume && skills.length > 0 && (
          <div className="mb-6">
            <h4 className="text-lg font-semibold text-gray-700 mb-3">Extracted Skills</h4>
        ...
        {/* Selected Skills */}
        <div>
          <h4 className="text-lg font-semibold text-gray-700 mb-3">Selected Skills</h4>
          <div className="flex flex-wrap gap-2">
...
const JobDescriptionSection = ({
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg mb-8">
      <h3 className="text-xl font-bold text-purple-600 mb-4">Job Description & Settings</h3>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <textarea
            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:border-transparent transition-all duration-200"
            rows="4"
          ...
          <div className="bg-gray p-4 rounded-lg">
            ...
            <div className="space-y-3">
              <label className="flex items-center p rounded-lg hover:bg-white transition-all duration-200 cursor-pointer">
                ...
                />
                <span className="ml-2 text-gray-700">Technical Questions</span>
              </label>
              <label className="flex items-center p rounded-lg hover:bg-white transition-all duration-200 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500"
                />
                <span className="ml-2 text-gray-700">Behavioral Questions</span>
              </label>
              <label className="flex items-center p rounded-lg hover:bg-white transition-all duration-200 cursor-pointer">
                <input
                  type="checkbox"
                  ...
                  className="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500"
                />
                <span className="ml-2 text-gray-700">Situational Questions</span>
              </label>
            </div>
          </div>
        </div>
...
const ProfileSection = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            disabled={!isEditing}
            className="w-full p-2 border border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500 disabled:bg-gray-100"
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">
        ...
        {isEditing && (
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-purple-600 text-white py-2 rounded-lg hover:bg-purple-700 transition-all duration-300 flex items-center justify-center cursor-pointer disabled:cursor-not-allowed "
          >
            {isLoading ? (
              <>
      ...
      <div className="mt-8">
        <h3 className="text-xl font-semibold text-purple-600 mb-4">Skills from Resume</h3>
        <div className="flex flex-wrap gap-2">
          {userData.skills && userData.skills.length > 0 ? (
            ...
            <p className="text-gray-500">No skills found. Upload a resume to extract skills.</p>
          )}
        </div>
      </div>
    </div>
...
const HistorySection = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md mt-8">
      <h2 className="text-2xl font-bold text-purple-600 mb-6">Question History</h2>
      ...
      {userData.saved_questions && userData.saved_questions.length > 0 ? (
        ...
        <p className="text-gray-500 text-center">No saved questions yet. Generate and save questions to see them here.</p>
      )}
    </div>
  );
};
