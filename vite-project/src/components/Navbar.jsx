      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:flex sm:items-center space-x-4">
            <Link
              to="/"
              className="text-white hover:text-purple-200 px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 hover:bg-purple-700"
            >
              Home
            </Link>
            <Link
      ...
      {isMenuOpen && (
        <div className="sm:hidden bg-gradient-to-r from-purple-600 to-pink-600 shadow-lg">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              to="/"
              className="block text-white hover:text-purple-200 px-3 py-2 rounded-md text-base font-medium transition-all duration-300 hover:bg-purple-700"
              onClick={toggleMenu}
            >
              Home
            </Link>
